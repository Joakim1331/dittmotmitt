    ...
    */
    public List<Item> fetchItems() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                item.EstimatedPrice = rs.getInt("estimatedPrice");
                item.datee = rs.getString("datee");
    ...
    public void addItem(Item item){
        try {
            Statement statement = connection.createStatement();
              ...
              String sql = "INSERT INTO item (UserID, Title, Image, Description, EstematedPrice, Date, TradeFor, Category, City) "
                      + "VALUES ('" + item.userID + "', "
                      + "'" + item.title + "', "
                      + "'" + item.image + "', "
                      + "'" + item.description + "', "
    ...
    public void updateItem(Item item){
        try {
            ...
            String sql = "UPDATE item SET id = " + item.id + ", "
                    +"userID = '" + item.userID + "', "
                    + "'" + item.title + "', "
                    + "'" + item.image + "', "
                    + "'" + item.description + "', "
